...
test('.manifest() - constructor has "pathname" and "manifest" set - "prefix" argument is set "false" - should return "manifest" without "pathname" prefix', t => {
    const options = {
        ...DEFAULT_OPTIONS,
        pathname: '/foo',
        manifest: '/component.json',
...
test('.content() - constructor has "pathname" and "content" set - "prefix" argument is default - should return "content" value prefixed with "pathname"', t => {
    const options = {
        ...DEFAULT_OPTIONS,
        pathname: '/foo',
...
test('.content() - constructor has "pathname" and "content" set - "prefix" argument is set "false" - should return "content"', t => {
    const options = {
        ...DEFAULT_OPTIONS,
        pathname: '/foo',
        content: '/bar/foo.html',
...
test('.fallback() - constructor has "pathname" and "fallback" set - "prefix" argument is default - should return "fallback" value prefixed with "pathname"', t => {
    const options = {
        ...DEFAULT_OPTIONS,
        pathname: '/foo',
...
test('.fallback() - constructor has "pathname" and "fallback" set - "prefix" argument is set "false" - should return "fallback"', t => {
    const options = {
        ...DEFAULT_OPTIONS,
        pathname: '/foo',
        fallback: '/bar/foo.html',
...
test('.css() - set legal relative value on "value" argument and "pathname" defined - should set "css" to set value with prefix prepended', t => {
